                    ...
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-6 col-xl-5">
                            <div class="footer-item">
                                <a href="../page/index.html" class="p-0">
                                ...
                                <div class="row g-3">
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-1.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-1.jpg"
                                    ...
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-2.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-2.jpg"
                                    ...
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-3.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-3.jpg"
                                    ...
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-4.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-4.jpg"
                                    ...
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-5.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-5.jpg"
                                    ...
                                    <div class="col-4">
                                        <div class="footer-instagram rounded">
                                            <img src="../layout/img/instagram-footer-6.jpg" class="img-fluid w-100"
                                                alt="">
                                            <div class="footer-search-icon">
                                                <a href="../layout/img/instagram-footer-6.jpg"
...
<script src="layout/lib/counterup/counterup.min.js"></script>
